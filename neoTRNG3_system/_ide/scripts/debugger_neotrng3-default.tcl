...
# Path of this script: C:\Users\mirap\Vivado\neoTRNG3\neoTRNG3_system\_ide\scripts\debugger_neotrng3-default.tcl
# 
# 
# Usage with xsct:
...
fpga -file C:/Users/mirap/Vivado/neoTRNG3/neoTRNG3/_ide/bitstream/design_1_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source C:/Users/mirap/Vivado/neoTRNG3/neoTRNG3/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config

...
# Path of this script: C:\Users\mirap\Vivado\neoTRNG3\bbbbbb_system\_ide\scripts\systemdebugger_bbbbbb_system_standalone.tcl
# 
# 
# Usage with xsct:
...
fpga -file C:/Users/mirap/Vivado/neoTRNG3/bbbbbb/_ide/bitstream/design_1_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source C:/Users/mirap/Vivado/neoTRNG3/bbbbbb/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow C:/Users/mirap/Vivado/neoTRNG3/bbbbbb/Debug/bbbbbb.elf
